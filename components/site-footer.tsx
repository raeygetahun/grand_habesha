    ...
    <footer className="border-t pattern-bg">
      <div className="container py-8 md:py-12">
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          <div>
            <h3 className="mb-4 text-sm font-bold uppercase tracking-wider">Subscribe</h3>
        ...
        <div className="mt-8 border-t pt-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-xs text-gray-500 dark:text-gray-400">
              &copy; {new Date().getFullYear()} Grand Habesha Business. All rights reserved.
            </p>
            <div className="flex gap-4 text-xs text-gray-500 dark:text-gray-400">
              <Link href="/privacy" className="hover:underline hover:text-amber-600 transition-colors duration-300">
                Privacy Policy
              </Link>
              <Link href="/terms" className="hover:underline hover:text-amber-600 transition-colors duration-300">
                Terms of Service
              </Link>
              <Link href="/cookies" className="hover:underline hover:text-amber-600 transition-colors duration-300">
                Cookie Policy
              </Link>
            </div>
          </div>
